...
export default function AdminDashboard() {
  ...
  const toggleSelectAll = () => {
    setSelectedEmails(
      selectedEmails.length === reports.length ? [] : reports.map((r) => r.agentEmail)
    );
  };
  ...
  return (
    <main className="pt-8 pb-8 max-w-6xl mx-auto">
      <header className="mb-12 flex justify-between">
        <div>
          <h1 className="text-5xl font-black tracking-tight dark:text-white">Admin Console</h1>
      ...
      {showModal && <InviteAgentModal showModal={showModal} setShowModal={setShowModal} />}
        ...
        <div className="lg:col-span-5 space-y-6 pt-6">
          ...
          <section>
            ...
            >
              ...
              <h2 className="text-2xl font-black dark:text-white mb-2">Manage Courses</h2>
              <p className="text-slate-500 font-medium">
                Create new training modules, upload videos/PDFs, and reorder lessons.
              </p>
